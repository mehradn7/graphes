...
(* entrees :
   ...
   *)
val associate : Skeleton.V.t -> Skeleton.V.t -> unit
...
(* entrees:
   ...
   *)
val separate : Skeleton.V.t -> Skeleton.V.t -> unit
...
(* entrees :
   ...
   specifs :
    ...
    - retire a du graphe
   *)
val contract : Skeleton.t -> Skeleton.V.t -> Skeleton.V.t -> Skeleton.V.t list
...
(* entrees :
   ...
   specifs :
    ...
    - insère l'arête (o,a)
   *)
val insert : Skeleton.t -> Skeleton.V.t -> Skeleton.V.t -> Skeleton.V.t list -> unit
...
*)
val equals_aux : Skeleton.t -> Skeleton.V.t -> Skeleton.t -> Skeleton.V.t -> bool*(Skeleton.V.t*Skeleton.V.t) list
...
*)
val equals : Skeleton.t -> Skeleton.V.t -> Skeleton.t -> Skeleton.V.t -> bool*(Skeleton.V.t*Skeleton.V.t) list
...
*)
val distance_aux : Skeleton.t -> Skeleton.V.t -> Skeleton.t -> Skeleton.V.t -> int*((Skeleton.V.t*Skeleton.V.t) list)*((Skeleton.V.t*Skeleton.V.t) list)*((Skeleton.V.t*Skeleton.V.t) list)
...
*)
val distance : Skeleton.t -> Skeleton.V.t -> Skeleton.t -> Skeleton.V.t -> int*((Skeleton.V.t*Skeleton.V.t) list)*((Skeleton.V.t*Skeleton.V.t) list)*((Skeleton.V.t*Skeleton.V.t) list)
...
*)
val distance_opti : Skeleton.t -> Skeleton.V.t -> Skeleton.t -> Skeleton.V.t -> int*((Skeleton.V.t*Skeleton.V.t) list)*((Skeleton.V.t*Skeleton.V.t) list)*((Skeleton.V.t*Skeleton.V.t) list)

...
Printf.printf "Test association\n%!";;
let t1 = Testprojet.test_associate associate obj1_1v1 obj1_2v4;;
if t1 then Printf.printf "ok\n%!";;
let t2 = Testprojet.test_associate associate obj1_1v3 obj1_2v5;;
if t2 then Printf.printf "ok\n%!";;
Printf.printf "\n%!";;

Printf.printf "Test séparation\n%!";;
let t3 = Testprojet.test_separate separate obj1_1v1 obj1_2v4;;
if t3 then Printf.printf "ok\n%!";;
let t4 = Testprojet.test_separate separate obj1_1v3 obj1_2v5;;
if t4 then Printf.printf "ok\n%!";;
Printf.printf "\n%!";;

Printf.printf "Test contraction\n%!";;
let t5 = Testprojet.test_contract contract obj1_1 obj1_1v1 obj1_1v2;;
if t5 then Printf.printf "ok\n%!";;
let t6 = Testprojet.test_contract contract obj1_2 obj1_2v1 obj1_2v2;;
if t6 then Printf.printf "ok\n%!";;
Printf.printf "\n%!";;

Printf.printf "Test insertion\n%!";;
let t7 = Testprojet.test_insert insert obj1_1 obj1_1v1 obj1_1v2;;
if t7 then Printf.printf "ok\n%!";;
let t8 = Testprojet.test_insert insert obj1_2 obj1_2v1 obj1_2v2;;
if t8 then Printf.printf "ok\n%!";;
Printf.printf "\n%!";;

Printf.printf "Test equals_aux\n%!";;
let t9  = Testprojet.test_equals_aux equals_aux obj1_1 obj1_1v5 obj1_2 obj1_2v4;;
if t9 then Printf.printf "ok\n%!";;
let t10 = Testprojet.test_equals_aux equals_aux obj1_1 obj1_1v5 obj1_3 obj1_3v3;;
if t10 then Printf.printf "ok\n%!";;
let t11 = Testprojet.test_equals_aux equals_aux obj1_2 obj1_2v4 obj1_3 obj1_3v3;;
if t11 then Printf.printf "ok\n%!";;
let t12 = Testprojet.test_equals_aux equals_aux obj2_1 obj2_1v3 obj2_2 obj2_2v1;;
if t12 then Printf.printf "ok\n%!";;
Printf.printf "\n%!";;

Printf.printf "Test equals\n%!";;
let t13 = Testprojet.test_equals equals obj1_1 obj1_1v5 obj1_2 obj1_2v4;;
if t13 then Printf.printf "ok\n%!";;
let t14 = Testprojet.test_equals equals obj1_1 obj1_1v5 obj1_3 obj1_3v3;;
if t14 then Printf.printf "ok\n%!";;
let t15 = Testprojet.test_equals equals obj1_2 obj1_2v4 obj1_3 obj1_3v3;;
if t15 then Printf.printf "ok\n%!";;
let t16 = Testprojet.test_equals equals obj2_1 obj2_1v3 obj2_2 obj2_2v1;;
if t16 then Printf.printf "ok\n%!";;
Printf.printf "\n%!";;

Printf.printf "Test distance et distance_opti\n%!";;
(*let t17 = Testprojet.test_dist_and_opti distance distance_opti obj1_1 obj1_1v5 obj1_2 obj1_2v4;;*)
let t18 = Testprojet.test_dist_and_opti distance distance_opti obj1_1 obj1_1v5 obj1_3 obj1_3v3;;
if t18 then Printf.printf "ok\n%!";;
Printf.printf "\n%!";;
(*let t19 = Testprojet.test_dist_and_opti distance distance_opti obj1_2 obj1_2v4 obj1_3 obj1_3v3;;*)
let t20 = Testprojet.test_dist_and_opti distance distance_opti obj2_1 obj2_1v3 obj2_2 obj2_2v1;;
if t20 then Printf.printf "ok\n%!";;
Printf.printf "\n%!";;
